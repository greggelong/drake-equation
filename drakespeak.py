...
def speakout(say):
    os.system('espeak "{}"'.format(say))#interpolate the string that you want to speak into your command.
    
    
def getRandDrake():
	print("*"*24)
	print("Random numbers for Drake")
	os.system('espeak "random numbers for the drake equation"')
	print("*"*24)
	print("(R), the average rate of star formations, in our galaxy is assumed to be 7 per year ")
	os.system('espeak "(R), the average rate of star formations, in our galaxy is assumed to be 7 per year "')
	...
	os.system('espeak "(p), the percentage of formed stars that have planets"')
	os.system('espeak "{} percent"'.format(p))
	...
	os.system('espeak "(n) for stars that have planets, the average number of planets that can potentially support life is"')
	os.system('espeak "{} planets"'.format(n))
	...
	os.system('espeak "(l), the percentage of those planets that actually develop life," ')
	os.system('espeak "{} percent"'.format(l))
	l_life.goto(400,400)
	l_life.begin_fill()
	l_life.circle(l)
	l_life.end_fill()
	...
	os.system('espeak  "(i), the percentage of planets bearing life on which intelligent,  life, has developed, " ')
	os.system('espeak "{} percent"'.format(i))
	...
	os.system('espeak "(c), the percentage of these civilizations that have developed communications, i.e., technologies that release detectable signs into space, "  ')
	os.system('espeak "{} percent"'.format(c))
	...
	os.system('espeak "(L), the length of time over which such civilizations release detectable signals, "  ')
	os.system('espeak "{} years"'.format(lenciv))
	...
	print("N =", numDeCiv)
	os.system('espeak "thus, N equals {} alien civilizations"'.format(int(numDeCiv)))
